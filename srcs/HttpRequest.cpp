...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/08/30 11:31:31 by spapyan           #+#    #+#             */
/*   Updated: 2023/08/30 11:31:31 by spapyan          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
    ...
    for (size_t i = 0; i < size; ++i) {
        ...
        switch (_state) {
            ...
            case Request_Line_URL_Path: {
                ...
                else if (!allowCharURI(character)) {
                    _error_code = 400;
...
void    HttpRequest::cutReqBody(int bytes) {
    _body_str = _boy_str.substr(bytes);
}