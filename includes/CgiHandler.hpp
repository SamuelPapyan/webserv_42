...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/08/28 09:01:50 by spapyan           #+#    #+#             */
/*   Updated: 2023/08/28 09:01:50 by spapyan          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
public:
    ...
    void        initEnvCgi(HttpRequest& req, cont std::vector<Location>::iterator it_loc);
